...
def test_video(vid):
    ...
    np.save(r"C:\Users\sumit\OneDrive\Desktop\MP\Abnormal-Human-Activity-Detection-System-main (1)\Abnormal-Human-Activity-Detection-System-main\DATASET\scene1\megaBlockMotInfVal_set1_p1_test_20-20_k5.npy",megaBlockMotInfVal)
    ######megaBlockMotInfVal = np.load("megaBlockMotInfVal_set3_p2_train_40_k7.npy")
    codewords = np.load(r"C:\Users\sumit\OneDrive\Desktop\MP\Abnormal-Human-Activity-Detection-System-main (1)\Abnormal-Human-Activity-Detection-System-main\DATASET\scene1\codewords_set1_p1_train_40-40_k5.npy")
...
if __name__ == '__main__':
    ...
    '''
    testSet = [r"C:\Users\sumit\OneDrive\Desktop\MP\Abnormal-Human-Activity-Detection-System-main (1)\Abnormal-Human-Activity-Detection-System-main\DATASET\scene1\test1.avi"]
